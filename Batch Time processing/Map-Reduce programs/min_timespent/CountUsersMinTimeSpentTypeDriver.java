...
public class CountUsersMinTimeSpentTypeDriver {
	...
	public static void main(String[] args) throws Exception {
		...
		args[1]="C:\\Users\\training_b6b.01.03\\Desktop\\hadoop\\MR005_OutPut";
		...
		job.setJarByClass(CountUsersMinTimeSpentTypeDriver.class);
		job.setMapperClass(CountUsersMinTimeSpentTypeMapper.class);
		job.setReducerClass(CountUsersMinTimeSpentTypeReducer.class);
