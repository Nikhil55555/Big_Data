...
public class CountUsersByCountryTypeDriver {
	public static void main(String[] args) throws Exception {
		...
		args= new String[3];
		args[0]="C:\\Users\\training_b6b.01.03\\Desktop\\hadoop\\goShopping_IpLookup.txt";
		args[1]="C:\\Users\\training_b6b.01.03\\Desktop\\hadoop\\MR001_OutPut";
		...
		job.setJarByClass(CountUsersByCountryTypeDriver.class);
		job.setMapperClass(CountUsersByCountryTypeMapper.class);
		job.setReducerClass(CountUsersByCountryTypeReducer.class);
