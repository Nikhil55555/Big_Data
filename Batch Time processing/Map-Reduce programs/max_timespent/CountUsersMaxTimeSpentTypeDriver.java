...
public class CountUsersMaxTimeSpentTypeDriver {
	...
	public static void main(String[] args) throws Exception {
		...
		args[1]="C:\\Users\\training_b6b.01.03\\Desktop\\hadoop\\MR004_OutPut";
		...
		job.setJarByClass(CountUsersMaxTimeSpentTypeDriver.class);
		job.setMapperClass(CountUsersMaxTimeSpentTypeMapper.class);
		job.setReducerClass(CountUsersMaxTimeSpentTypeReducer.class);
